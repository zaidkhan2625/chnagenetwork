...
export default function Login() {
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      ...
      localStorage.setItem("schedulerUserInfo", JSON.stringify(user));
      setUser(user);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <Head>
        ...
        <meta name="description" content="Login to the admin panel" />
      ...
      <div className="mt-8 sm:mx-auto sm:w-full text-black sm:max-w-md">
          ...
          <form className="space-y-6 text-black" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block cursor-not-allowed text-sm text-gray-900">
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium text-indigo-600 cursor-not-allowed hover:text-indigo-500">
